...
/** 
 * This page servers different enpoint functionalities based on slug requested by  page instead params
 * Calling exmaple: http://localhost:4321/api/posts/post-01
*/
